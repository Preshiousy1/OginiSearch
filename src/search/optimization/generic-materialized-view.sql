-- ============================================================================
-- GENERIC POSTGRESQL OPTIMIZATIONS FOR TYPO TOLERANCE
-- ============================================================================
-- This script creates generic, index-agnostic optimizations
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_search_terms_gin_trgm ON search_terms USING GIN (term gin_trgm_ops);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_search_terms_gist_trgm ON search_terms USING GIST (term gist_trgm_ops);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_search_terms_btree ON search_terms (index_name, term);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_search_terms_frequency ON search_terms (
    index_name,
